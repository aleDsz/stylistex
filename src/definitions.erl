-file("/Users/aledsz/.asdf/installs/erlang/21.3.8.9/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("./src/definitions.xrl", 16).

-file("/Users/aledsz/.asdf/installs/erlang/21.3.8.9/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(7, [10|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line+1, Tlen+1, 5, Tlen);
yystate(7, Ics, Line, Tlen, _, _) ->
    {5,Tlen,Ics,Line,7};
yystate(6, [93|Ics], Line, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [91|Ics], Line, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [44|Ics], Line, Tlen, Action, Alen) ->
...
-file("./src/definitions.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("./src/definitions.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/1}).
-file("./src/definitions.xrl", 9).
yyaction_2(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("./src/definitions.xrl", 10).
yyaction_3(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("./src/definitions.xrl", 11).
yyaction_4(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_5/0}).
-file("./src/definitions.xrl", 12).
yyaction_5() ->
     skip_token .

-file("/Users/aledsz/.asdf/installs/erlang/21.3.8.9/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
